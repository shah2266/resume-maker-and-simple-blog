        ...
        <div class="col-md-12">
            <div class="box box-solid">
                ...
                <div class="box-header with-border btn-force">
                    <h3 class="box-title" style="margin-left: 15px" id="modelHeading"></h3>
                </div>

                <div class="box-body">
                    <div class="col-sm-5">
                        <form id="formChecking" name="tagForm" method="POST" class="form-horizontal">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <div class="submit-btn">
                                        <button type="submit" id="saveBtn" class="btn btn-success"><i class="fa fa-save"></i> Submit</button>
                                        <a id="cancel" class="btn btn-danger" style="display: none"><i class="fa fa-times"></i> Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
